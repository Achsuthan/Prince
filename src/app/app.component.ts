...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'User View', component: UserViewPage,name:'home' },
      { title: 'Bus Map', component: BusMapPage,name:'home' },
      { title: 'User Print', component: UserPrintPage,name:'home' },
      { title: 'Logout', component: LoginPage,name:'home' }
    ];
